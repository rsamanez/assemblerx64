...
;;
;;         nasm -felf64 -o server.o echoServer64.asm
;;         ld server.o -o server
;;         ./server
;;
;; Original code from:  https://gist.github.com/bobbo/e1e980262f2ddc8db3b8
;;  Author:  David Futcher
;--------------------------------------------------------------------------
...
section .data
    ...
    pop_sa istruc sockaddr_in
        ...
        at sockaddr_in.sin_port, dw  0x1027        ; port 60833
