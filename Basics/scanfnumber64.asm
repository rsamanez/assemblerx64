; How to scanf a 8bytes number Program
; Compile with:
;     nasm -f elf64 -o scanfnumber64.o scanfnumber64.asm
; Link with:
;     ld -m elf_x86_64 -o scanfnumber64 scanfnumber64.o
; Run with:
;     ./scanfnumber64
;==============================================================================
...
section .rodata    ; read only data section
  msg: db "Write a number and then press [ENTER]:",0
